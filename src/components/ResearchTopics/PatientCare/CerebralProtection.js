        ...
        return (
            <div className='container'>
                ...
                <div className="subpageContainer">
                    ...
                    <p>In evaluating any type of cooling technique that is employed without anesthesia, it is considered that skin warmth and thus vasodilation must be controlled in order to avoid counter-productive shivering. Thus, initial studies in our labs have aimed to comparatively assess the clinical application of focal facial warming and focal hand warming with several different cooling techniques in healthy, unanesthetized subjects.</p>
                <div>
                    <h6>Related articles from the labs:</h6>
                    <ul>
