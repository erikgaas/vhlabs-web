            ...
            <div className='container'>
                <h2><a href="/research" className="researchSubPageBreadcrumb"> Research</a> > <a href="/research-ca" className="researchSubPageBreadcrumb">Cardiac</a></h2>
                    <div className="subpageContainer">
                        ...
                        <p>Researchers in our labs have compiled previously published information comparing large mammalian cardiac anatomy, determined the current opinions on large mammalian cardiac anatomy, and critically described qualitative and quantitative details of the anatomy of swine, canine, and ovine hearts, all which are used as animal models in cardiovascular research. Additionally, unique methodologies for the study of isolated human hearts have been described. Our results showed two major points:</p>
                        <ol>
