											...
											<div className="col-md-2" id="homeElementColumnFix">
															<div className="card" id="homeElementCard" >
																<a href="/about" id="homeElementLink">
																	<h3>About Us</h3>	
																	<img className="card-img-top" src={process.env.PUBLIC_URL + "/images/homeelements/ourlab3.jpg"} alt="Visible Heart Labs" />
																	<div className="card-body" id="cardBodyFix">
																		<p className="card-text">Our personnel and the VHL's mission</p>
																	</div>
																</a>
															</div>
											</div>
											...
											<div className="col-md-2" id="homeElementColumnFix">
													<div className="card" id="homeElementCard" >
														<a href="/research" id="homeElementLink">
															...
															<div className="card-body" id="cardBodyFix">
																<p className="card-text">Information about our research objectives</p>
															</div>
														</a>
													</div>
											</div>
											...
											<div className="col-md-2" id="homeElementColumnFix">
													<div className="card" id="homeElementCard" >
														<a href="/outreach" id="homeElementLink">
															...
															<div className="card-body" id="cardBodyFix">
																<p className="card-text">Training and educating the next generation of researchers</p>
															</div>
														</a>
													</div>
											</div>
											...
											<div className="col-md-2" id="homeElementColumnFix">
													<div className="card" id="homeElementCard" >
														<a href="/clinical" id="homeElementLink">
															...
															<div className="card-body" id="cardBodyFix">
																<p className="card-text">Our work as an MH clinical diagnostic center</p>
															</div>
														</a>
													</div>
											</div>
											...
											<div className="col-md-2" id="homeElementColumnFix">
													<div className="card" id="homeElementCard" id="lastElementCard">
														<a href="http://www.vhlab.umn.edu/atlas/index.shtml" id="homeElementLink">
															...
															<div className="card-body" id="cardBodyFix">
																<p className="card-text">Our public library of human cardiac anatomy</p>
															</div>
														</a>
													</div>
											</div>
