		...
		return (
			<div className='container'>
				...
				performing research and teaching graduate and
				 ...
				 heart models, and thus the Visible Heart® Laboratories were
				 created in collaboration with Medtronic. Today, these
				 labs are a premiere place to perform translational systems
				 ...
				 Laboratories embody a creative atmosphere which is energized by
