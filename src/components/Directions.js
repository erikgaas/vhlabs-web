		...
		return (
				<div className='container'>
					...
					<div>
						...
						<div>
						<p>The Visible Heart® Laboratories are located at the University of Minnesota in the Mayo Memorial Building, on the East Bank of the University of Minnesota campus.</p>
						<p>If you are driving to the labs, the East River Road Garage is the easiest place to park. <strong>To get to the garage:</strong></p>
							<ul>
								<li>
